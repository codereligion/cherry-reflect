...
import com.codereligion.cherry.reflect.internal.ForwardingBeanInfo;
...
/**
 * A decorator for a {@link BeanInfo} implementation that assures that known bugs with generics in Java version 1.6 do not occur when reading properties.
 *
...
public final class GenericTypeAwareBeanInfo extends ForwardingBeanInfo {
    ...
    /**
     * Determines whether the given {@code propertyDescriptor} may have the characteristics, which indicate that the bug occurred and further analysis may be
     * necessary.
     *
    ...
    /**
     * Tries to find a public non-bridged method in the given {@code type} which matches the given {@code methodName}.
     *
