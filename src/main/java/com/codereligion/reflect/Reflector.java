...
public final class Reflector {
	...
	/**
	 * Determines whether the given {@code propertyDescriptor} may have the characteristics, 
	 * which indicate that the bug occurred and further analysis may be necessary.
	 * 
